...
export default function EmployeeEdit() {
  ...
  const onSubmit = async (_data: EmployeeFormValues) => {
    // TODO: wire to update employee API in Phase 7 integration (id: ${id})
      ...
      <div className="max-w-[900px] mx-auto p-8">
        ...
        <header className="mb-8">
          <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">
            Edit Employee{id ? <span className="text-slate-400 text-sm ml-2">#{id}</span> : null}
          </h1>
        ...
        <form
          ...
          noValidate
          data-testid="admin-employee-edit-form"
        >
          <section className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-1.5 md:col-span-2">
                <button data-testid="admin-employee-edit-avatar-upload-btn"
                  type="button"
                  onClick={() => {
              ...
              <div className="space-y-1.5">
                ...
                <input data-testid="admin-employee-edit-fullname-input"
                  id="fullName"
                  type="text"
              ...
              <div className="space-y-1.5">
                ...
                <input data-testid="admin-employee-edit-email-input"
                  id="email"
                  type="email"
              ...
              <div className="space-y-1.5">
                ...
                <input data-testid="admin-employee-edit-phone-input"
                  id="phone"
                  type="tel"
          ...
          <section className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                ...
                <input data-testid="admin-employee-edit-position-input"
                  id="position"
                  type="text"
              ...
              <div className="space-y-1.5">
                ...
                <select data-testid="admin-employee-edit-department-select"
                  id="department"
              ...
              <div className="space-y-1.5">
                ...
                <select data-testid="admin-employee-edit-team-leader-select"
                  id="teamLeader"
                  className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-slate-900"
                  {...register('teamLeader')}
                >
              ...
              <div className="space-y-1.5">
                ...
                <input data-testid="admin-employee-edit-start-date-input"
                  id="startDate"
                  type="date"
                  className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-slate-900"
                  {...register('startDate')}
              ...
              <div className="space-y-1.5">
                ...
                <select data-testid="admin-employee-edit-status-select"
                  id="status"
                  className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-slate-900"
                  {...register('status')}
                >
            ...
            <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input data-testid="admin-employee-edit-salary-input"
                    id="salary"
                    type="number"
                    placeholder="0.00"
              ...
              <div className="space-y-1.5">
                ...
                <input data-testid="admin-employee-edit-bank-name-input"
                  id="bankName"
                  type="text"
              ...
              <div className="space-y-1.5 md:col-span-2">
                ...
                <input data-testid="admin-employee-edit-account-number-input"
                  id="accountNumber"
                  type="text"
          ...
          <section className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                ...
                <input data-testid="admin-employee-edit-gather-input"
                  id="gather"
                  type="email"
              ...
              <div className="space-y-1.5">
                ...
                <input data-testid="admin-employee-edit-notion-input"
                  id="notion"
                  type="text"
          ...
          <div className="flex items-center justify-end gap-3">
            <Link
              ...
              data-testid="admin-employee-edit-cancel-link"
            >
              Cancel
            </Link>
            <button data-testid="admin-employee-edit-submit-btn"
              type="submit"
